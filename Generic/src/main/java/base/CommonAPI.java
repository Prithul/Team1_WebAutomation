...
//    }
    ...
    public void setUp(@Optional("false") boolean useCloudEnv, @Optional("false")String cloudEnvName,
        ...
        System.setProperty("webdriver.chrome.driver", "C:\\Users\\HALIMA\\IdeaProjects\\Team1\\Generic\\browser-driver\\chromedriver.exe");
        if(useCloudEnv==true){
    ...
    public WebDriver getCloudDriver(String envName,String envUsername, String envAccessKey,String os, String os_version,String browserName,
        ...
        System.out.println(envAccessKey);
        System.out.println(envName);
        System.out.println(envUsername);
        ...
        if(envName.equalsIgnoreCase("Saucelabs")){
            ...
            System.out.println("here at browser stack");
        }
        return driver;
    }
